...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    exchange_rate_plus_spread = exchange_rate * (1 + spread / 100)

    total = exchange_money(budget, exchange_rate_plus_spread)
    numbers = get_number_of_bills(total, denomination)
    return numbers * denomination
